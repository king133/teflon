/* Simple irc bot.
   ...
   for SSL:
   ./teflon ##irc.rizon.net:6697 teflon #teflon 
   
   for non-SSL:
   ./teflon irc.rizon.net:6666 teflon #teflon 
*/
